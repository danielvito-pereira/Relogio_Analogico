...
function executarRelogio() {
    ...
    posicaoSeg = posicaoSeg+6;//pego o valor atual e adiciono um segundo 
...
var intervalo = setInterval(executarRelogio, 1000);//ser interval repete a fução segundo o intervalo definido 